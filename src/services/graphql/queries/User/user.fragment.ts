...
export const USER_FIELDS_LIGHT_WITH_NAME_AND_EMAIL = gql`
  fragment UserFieldsWithIdAndNameAndEmail on User {
    id
    first_name
    last_name
    email
...
export const USER_FIELDS_LIGHT_WITH_NAME_AND_IMAGE = gql`
  fragment UserFieldsWithIdAndNameAndImage on User {
    id
    first_name
    last_name
    file_id
